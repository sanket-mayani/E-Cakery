...
<%
	...
	if(request.getParameter("flavour")!=null)
		flavourName = request.getParameter("flavour");
	
	flavour = dao.getFlavourByName(flavourName);
...
<head>
	...
	<title><%out.print(flavourName);%> Cakes</title>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<span>></span>
				<span><%out.print(flavourName);%> Cakes</span>
			</div>
		</div>
